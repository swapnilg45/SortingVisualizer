...
## Frame / Base layout
UI_frame = Frame(root, width= 100, height=200, bg = 'grey')
...
sizeEntry.grid(row=1, column=0, pady=5, padx=5)

minEntry = Scale(UI_frame, from_= 0, to = 10, resolution=1, orient=HORIZONTAL, label="Min Value")
minEntry.grid(row=1, column=1, pady=5, padx=5)

maxEntry = Scale(UI_frame, from_= 10, to = 100, resolution=1, orient=HORIZONTAL, label="Max Value")
maxEntry.grid(row=1, column=2, pady=5, padx=5)

Button(UI_frame, text = 'Generate', command= Generate, bg = 'white').grid(row=1, column=3, pady=5, padx=5)
